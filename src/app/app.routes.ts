...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'enrolements', loadComponent: () => import('./pages/enrolements/enrolements.component').then(m => m.EnrolementsComponent) },
      ...
      { path: 'carte', loadComponent: () => import('./pages/carte/carte.component').then(m => m.CarteComponent) },
    ]
  },
